...
const mockAdapter = {
  ...
  getMaxChunkSize: jest.fn().mockReturnValue(50)
};

jest.mock('../../adapters/llm-adapter-factory', () => ({
  LLMAdapterFactory: {
...
describe('TranslationService', () => {
  ...
  describe('Job Creation', () => {
    it('should create a translation job with correct structure', () => {
  ...
  describe('Progress Tracking', () => {
    it('should call progress callback during translation', () => {
  ...
  describe('Adapter Integration', () => {
    it('should use the correct chunk size from adapter', () => {
      const config: LLMConfig = {
        provider: 'mock',
        apiKey: 'test-key'
      };
