...
describe('FileService - BetterQuest File Discovery (Bun)', () => {
  beforeEach(() => {
  ...
  describe('get_better_quest_files with DefaultQuests.lang support', () => {
    ...
    it('should handle errors appropriately', async () => {
      ...
      try {
        await FileService.invoke('get_better_quest_files', { dir: '/invalid' });
...
quest.2.subtitle=Optional subtitle text`;
      ...
      expect(Object.keys(langMap).length).toBe(5);
    });
