...
describe('Translation Runner', () => {
  ...
  let mockCallbacks: {
    onJobStart: any;
    onJobChunkComplete: any;
    onJobComplete: any;
    onJobInterrupted: any;
    onResult: any;
    writeOutput: any;
  };
  ...
  beforeEach(() => {
    ...
    mockCallbacks = {
      ...
      onResult: mock(),
      writeOutput: mock(() => Promise.resolve(undefined))
    };
  });

  describe('Single Job Processing', () => {
    test('should process a single job with one chunk successfully', async () => {
  ...
  describe('Error Handling', () => {
    test('should handle chunk translation failures', async () => {
    ...
    test('should handle output writing failures', async () => {
      ...
      const writeOutputMock = mock(() => Promise.reject(new Error('Write failed')));
  ...
  describe('Job Interruption', () => {
    test('should handle job interruption during processing', async () => {
      const job1 = createMockTranslationJob(mockModData.simpleMod.content, 'ja_jp', 'mod1.jar');
      const job2 = createMockTranslationJob(mockModData.specialMod.content, 'ja_jp', 'mod2.jar');
    ...
    test('should handle chunk-level interruption', async () => {
  ...
  describe('Progress Tracking Integration', () => {
    test('should track chunk-level progress correctly', async () => {
    ...
    test('should track mod-level progress correctly', async () => {
      const jobs = [
  ...
  describe('Result Generation', () => {
    test('should generate correct translation results', async () => {
      const content = mockModData.simpleMod.content;
      const job = createMockTranslationJob(content, 'ja_jp', 'simple_mod.jar');
      job.chunks = [{
        id: 'chunk_0',
