...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("flex-1 outline-none animate-in fade-in-0 slide-in-from-bottom-2 duration-300", className)}
      {...props}
    />
  )
}
